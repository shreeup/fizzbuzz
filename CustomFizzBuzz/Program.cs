    ...
    static void Main(string[] args)
    {
        ...
        // }
          ...
          Console.Clear();
            ...
            resultofFizzBuzz=new TwistedFizzBuzz("Fizz","Fizz",3,5).FizzBuzzForRange(new int[]{5,10,15,20,25,30,35,40,45,50});
            foreach(string s in resultofFizzBuzz){
                Console.WriteLine(s);
            }
            ...
            resultofFizzBuzz=new TwistedFizzBuzz("Fizz","Buzz",3,9).FizzBuzzForRange(new int[]{9,18,27,36,45,54,63,72,81,90});
            foreach(string s in resultofFizzBuzz){
                Console.WriteLine(s);
            }
            ...
            resultofFizzBuzz=new TwistedFizzBuzz("Fizz","Bar",3,27).FizzBuzzForRange(new int[]{27, 54, 81, 108, 135, 162, 189, 216, 243,270});
            foreach(string s in resultofFizzBuzz){
                Console.WriteLine(s);
            }
